            ...
            <div class="box-body">
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group" style="margin-top:18px;">
                  ...
                  <select class="form-control"  data-placeholder="Select a State" style="width: 100%;" tabindex="-1" aria-hidden="true" name="tags[]">
                    @foreach ($tags as $tag)
                    <option value="{{ $tag->id }}"
                ...
                <div class="form-group" style="margin-top:18px;">
                  ...
                  <select class="form-control"  data-placeholder="Select a State" style="width: 100%;" tabindex="-1" aria-hidden="true" name="categories[]">
